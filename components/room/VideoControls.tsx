  ...
  return (
    <div className="max-w-6xl mx-auto">
      <motion.div
        ...
        className="bg-gradient-to-r from-purple-50 to-pink-50 p-4 sm:p-6 rounded-xl sm:rounded-2xl premium-shadow-lg"
      >
        <div className="flex flex-col sm:flex-row gap-3">
          <div className="flex-1 relative group">
            ...
            >
              <Icons.Youtube className="text-red-500 w-5 h-5 sm:w-6 sm:h-6" />
            </motion.div>
            <input
              type="text"
              value={videoUrl}
              ...
              className="w-full pl-12 sm:pl-14 pr-4 py-3 sm:py-4 bg-white premium-shadow rounded-xl sm:rounded-2xl text-gray-800 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 transition-all text-xs sm:text-sm font-medium"
              disabled={isLoading}
            />
            <motion.div
              initial={false}
          ...
          <motion.button
            ...
            className="px-6 sm:px-8 py-3 sm:py-4 bg-gradient-to-r from-purple-500 to-pink-500 text-white font-bold rounded-xl sm:rounded-2xl hover:from-purple-600 hover:to-pink-600 transition-all disabled:opacity-50 disabled:cursor-not-allowed premium-shadow-lg flex items-center justify-center gap-2 sm:gap-3 group"
          >
            {isLoading ? (
              <>
                <motion.div
